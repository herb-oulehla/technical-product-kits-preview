# Home Energy Metering Commissioning Kit — public preview

**Buyer:** Home Assistant users adding gas/electricity/pulse meters who want trustworthy readings and fail-safe assumptions.  
**Promise:** Commission a home energy meter without confusing pulse constants, units, safety boundaries, or HA availability.  
**Price hypothesis:** €29 intro / €79 with example configs  
...
```markdown
# Sample filled report — Home Energy Metering Commissioning Kit

## Context

Example buyer: fictional small team / household operator.  
Category: Smart home / energy monitoring.  
Goal: Commission a home energy meter without confusing pulse constants, units, safety boundaries, or HA availability.
