# Docker Compose Observability Gap Kit — public preview
...
```markdown
# Sample filled report — Docker Compose Observability Gap Kit

## Context

Example buyer: fictional small team / household operator.  
Category: Self-hosted / homelab / small ops.  
Goal: Find missing healthchecks, restart policy gaps, log blind spots, and backup/restore assumptions in one pass.
