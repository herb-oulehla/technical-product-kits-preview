# Azure Functions Service Bus Resilience Kit — public preview

**Buyer:** Small Azure teams running ServiceBusTrigger functions with retries, poison messages, and dead-letter uncertainty.  
**Promise:** Expose the five places a Service Bus function can silently lose reliability confidence.  
**Price hypothesis:** €49 intro / €129 with interpreted example report  
...
```markdown
# Sample filled report — Azure Functions Service Bus Resilience Kit

## Context

Example buyer: fictional small team / household operator.  
Category: Cloud operations / serverless reliability.  
Goal: Expose the five places a Service Bus function can silently lose reliability confidence.
