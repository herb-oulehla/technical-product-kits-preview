# Obsidian Household Second Brain Starter Kit — public preview

**Buyer:** Families who want a practical shared Second Brain without buying SaaS or building a complex system.  
**Promise:** Start a household PARA vault with capture, projects, areas, resources, and weekly review in under one hour.  
**Price hypothesis:** €19 intro / €39 standard  
...
```markdown
# Sample filled report — Obsidian Household Second Brain Starter Kit

## Context

Example buyer: fictional small team / household operator.  
Category: Personal productivity / household operations.  
Goal: Start a household PARA vault with capture, projects, areas, resources, and weekly review in under one hour.
