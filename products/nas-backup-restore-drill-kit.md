# NAS Backup Restore Drill Kit — public preview

**Buyer:** Households and small offices with Synology/NAS backups that have never been restored on purpose.  
**Promise:** Convert backup confidence from hope into a documented restore drill.  
**Price hypothesis:** €29 intro / €69 family office pack  
...
```markdown
# Sample filled report — NAS Backup Restore Drill Kit

## Context

Example buyer: fictional small team / household operator.  
Category: Home/small office resilience.  
Goal: Convert backup confidence from hope into a documented restore drill.
