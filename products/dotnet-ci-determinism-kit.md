# .NET CI Determinism Kit — public preview
...
```markdown
# Sample filled report — .NET CI Determinism Kit

## Context

Example buyer: fictional small team / household operator.  
Category: Developer productivity / CI hygiene.  
Goal: Make .NET CI failures reproducible before adding more pipeline complexity.
