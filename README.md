...
1. **SQL Server Query Store Triage Kit** — workload-backed SQL triage for .NET/SQL teams.
2. **EF Core Performance Review Pack** — generated-SQL evidence workflow for EF Core performance reviews.
